...
class Appointment_DB():
    ...
    def run(self):
        ...
        print 'Appointment Reminder start: ', datetime.datetime.now()
        while True:
            ...
            for a in appointments:
                ...
                appt_cust_email = 'fedusrlive@yahoo.com' #a['cust_email']
                ...
                # SMS setup
                appt_cust_phone = '8125988559' #a['cust_phone']
...
if __name__ == '__main__':
    logfile = '../../../../logs/appointmentReminderError.log'
