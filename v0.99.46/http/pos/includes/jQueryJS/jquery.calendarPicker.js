jQuery.fn.calendarPicker = function(options) {
  ...
  if (!options.Year || !options.Month || !options.Day) {
    ...
    options.date = new Date(options.Year,options.Month,options.Day)
  }
  ...
  calendar.changeDate = function(date) {
    ...
    calendar.currentDate2 = date.getFullYear() + '-' + twoDigitMonth + '-' + twoDigitDate;
  ...
  theDiv.click(function(ev) {
    ...
    if (el.hasClass("calElement")) {
      ...
      //alert( "Old Date"+options.date +" New Date:"+calendar.currentDate2)
      AppointmentCalendar_Display_ChangeDate(calendar.currentDate2)
    }
  });
  //if mousewheel
