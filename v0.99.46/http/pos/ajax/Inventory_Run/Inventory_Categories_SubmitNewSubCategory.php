...
if ( $_GET['addNewCategory'] == "1") {
        ...
        $addNewCategorySql = "insert into categories
            (company_id,type,parent_id,name,attribute1,attribute2,added)
            values ($company_id,'shop',$parent_category_id,".quoteSmart($new_itemcategory_name).",".quoteSmart($new_attribute1).",".quoteSmart($new_attribute2).",convert_tz(now(), 'utc', 'america/chicago') );
            ";
        #echo $sql;
